...
Before finishing, verify each figure (from pedrohcgs/Codex-my-workflow):
...
Design pattern (type × style matrix) inspired by [baoyu-skills](https://github.com/jimliu/baoyu-skills). Publication style defaults and figure rules from [pedrohcgs/Codex-my-workflow](https://github.com/pedrohcgs/Codex-my-workflow). Visualization decision tree from [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills).
